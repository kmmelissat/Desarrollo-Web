...
const alumnos = [
    { id: 1, nombre: "Karla Melissa", apellido: "Torres Solorzano", correo:
    "melissa.solorzano@estudiante.esen.edu.sv" },
    { id: 2, nombre: "Daniela Rocio", apellido: "Pineda Pineda", correo:
    "daniela.pineda@estudiante.esen.edu.sv" },
